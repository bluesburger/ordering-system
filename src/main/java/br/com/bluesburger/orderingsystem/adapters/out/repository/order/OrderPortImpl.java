...
import br.com.bluesburger.orderingsystem.adapters.out.repository.user.UserRepository;
...
public class OrderPortImpl implements OrderPort {
    ...
    public List<Order> getOrdersByUser(User user) {
    	var userEntity = userRepository.getUserByCpf(user.getCpf());
        var orderEntityList = orderRepository.findAllByUserEntity(userEntity);
